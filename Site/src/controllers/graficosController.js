...
function atualizarGraficoPorCarro(req, res) {
    var codigo = req.params.codigo;

    graficosModel.atualizarGraficoPorCarro(codigo)
        .then(
            function (resultado) {
                if (resultado.length > 0) {
                    res.status(200).json(resultado);
...
function atualizarGraficoPorModelo(req, res) {
    var alerta = req.body.alerta;
    var modelo_id = req.body.modelo_id;
    ...
    if (modelo_id == undefined) {
        ...
        graficosModel.atualizarGraficoPorModelo(modelo_id, alerta)
            .then(
                function (resultado) {
                    if (resultado.length > 0) {
                        res.status(200).json(resultado);
